...
class TransactionRecord {
  ...
  toJSON() {
    return {
      ...
      parentConsensusTimestamp: this.parentConsensusTimestamp != null ? this.parentConsensusTimestamp.toDate() : null,
      ...
      tokenAllowanceAdjustments: [],
      nftAllowanceAdjustments: [],
      ethereumHash: this.ethereumHash != null && this.ethereumHash.length != 0 ? hex.encode(this.ethereumHash) : null,
      paidStakingRewards: this.paidStakingRewards,
      prngBytes: this.prngBytes,
      prngNumber: this.prngNumber,
      evmAddress: this.evmAddress != null && this.evmAddress.toBytes().length != 0 ? hex.encode(this.evmAddress.toBytes()) : null
    };
  }
